...
def main(model_file, testing_file):
    ...
    for sample in samples:
        try:
            ...
            """ Catch the error thrown when not finding any matchin
                              hla in mhc_i_protein_sequence.txt in hla_encode_ONE_HOT call """
            print('{},{},{} (log_ic50),{} (binary)'.format(sample[0], sample[1], 0, 0))
        except:
            """Catch all other error thrown"""
            print('{},{},{} (log_ic50),{} (binary)'.format(sample[0], sample[1], 0, 1))
